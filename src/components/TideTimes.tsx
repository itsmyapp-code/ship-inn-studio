...
export default async function TideTimes() {
  try {
    const feed = await parser.parseURL('https://www.tidetimes.org.uk/porlock-weir-tide-times.rss')
    ...
    return (
      <div className="bg-white rounded-lg shadow-lg p-6 border-t-4 border-ship-blue-500">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
          <a 
            href="https://www.tidetimes.org.uk/porlock-weir-tide-times" 
            target="_blank" 
